...
approach / əˈproʊtʃ / n. 态度
approach”指的是对待某个问题、主题或领域的方法或态度。在这种情况下，它指的是硅谷对待人工智能初创公司的方式或态度。
lean / liːn / v.  倾向于做；倚靠
pragmatic / præɡˈmætɪk / adj.  讲求实际的，务实的；实用主义的；（语言学）语用的
productization 产品化
Pioneers / ˌpaɪəˈnɪr / vt 做先锋，倡导；开辟 ，表示开拓或领先。
"0 to 1 innovations" 指的是从零开始的全新创新，而不是仅仅进行增量改进。
...
tolerating less than-perfect user experiences. "Tolerating" 意味着接受或容忍，"less-than-perfect" 意味着不完美或不理想的，"user experiences" 指的是用户在使用产品或服务时所感受到的整体体验。
